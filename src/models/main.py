...
import sys
# sys.path
sys.path.append('./Machine Learning Operations 21/mnist_cookiecutter') # need to add path

# load data
from src.data.data1 import *
train_loader, test_loader = load_mnist() # this will download mnist data, or load it if already downloaded
# load model
